...
class Transport extends EnhancedEventEmitter_1.EnhancedEventEmitter {
     ...
     * Create a Producer.
     */
    async produce({ track, encodings, codecOptions, codec, stopTracks = true, disableTrackOnPause = true, zeroRtpOnPause = false, appData = {}, localDtlsRole } = {}) {
     ...
     */
    async consume({ id, producerId, kind, rtpParameters, appData = {}, localDtlsRole, }) {
        ...
        return this._awaitQueue.push(async () => {
            ...
            const { localId, rtpReceiver, track } = await this._handler.receive({ trackId: id, kind, rtpParameters, localDtlsRole });
     ...
     */
    async produceData({ ordered = true, maxPacketLifeTime, maxRetransmits, priority = 'low', label = '', protocol = '', appData = {}, localDtlsRole } = {}) {
     ...
     */
    async consumeData({ id, dataProducerId, sctpStreamParameters, label = '', protocol = '', appData = {}, localDtlsRole }) {
