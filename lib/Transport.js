...
class Transport extends EnhancedEventEmitter
{
	 ...
	 * @param {Number} [maxPacketLifeTime] // TODO: default value?
	 * @param {Number} [maxRetransmits] // TODO: default value?
	...
	)
	{
		...
		if (this._direction !== 'send')
			throw new UnsupportedError('not a sending Transport');
		else if (!this._sctpMaxMessageSize)
	 ...
	 * @param {Object} sctpStreamParameters - Server-side DataConsumer SCTP parameters.
	 * @param {Object} [appData={}] - Custom app data.
	 *
	 * @async
	...
	)
	{
		...
		return this._awaitQueue.push(
			async () =>
			{
				const {
					dataChannel
				} = await this._handler.receiveDataChannel({ sctpStreamParameters });
