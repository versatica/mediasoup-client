...
export default class Receiver extends EnhancedEventEmitter
{
	...
	/**
	 * Whether the Receiver is locally paused.
	 *
	 * @return {Boolean}
	 */
	get locallyPaused()
	...
	/**
	 * Whether the Receiver is remotely paused.
	 *
	 * @return {Boolean}
	 */
	get remotelyPaused()
	...
	/**
	 * Whether the Receiver is actually receiving media.
	 *
	 * @return {Boolean}
	 */
	get active()
	...
	/**
	 * My remote Sender or the remote Peer or Room was closed.
	...
	pause(appData)
	{
		...
		if (this._closed)
		{
			logger.error('pause() | Receiver closed');

			return false;
		}
		else if (!this._handled)
		{
			logger.error('pause() | Receiver not handled');
	...
	resume(appData)
	{
		...
		if (this._closed)
		{
			logger.error('resume() | Receiver closed');
