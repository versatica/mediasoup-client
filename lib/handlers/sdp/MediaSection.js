...
class OfferMediaSection extends MediaSection {
    ...
    planBStopReceiving({ offerRtpParameters }) {
        ...
        this._mediaObject.payloads = this._mediaObject.payloads.split(' ')
            ...
            .join(' ');
        this._mediaObject.rtp = this._mediaObject.rtp.filter((rtp) => !payloads.includes(rtp.payload));
        this._mediaObject.rtcpFb = this._mediaObject.rtcpFb.filter((rtcpFb) => !payloads.includes(rtcpFb.payload));
        this._mediaObject.fmtp = this._mediaObject.fmtp.filter((fmtp) => !payloads.includes(fmtp.payload));
