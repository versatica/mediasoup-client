...
class RemoteSdp {
    ...
    _addMediaSection(newMediaSection) {
        ...
        let availableIdx = -1;
        if (newMediaSection instanceof MediaSection_1.OfferMediaSection) {
            availableIdx = this._mediaSections.findIndex((ms) => ms instanceof MediaSection_1.OfferMediaSection &&
                ms.closed &&
