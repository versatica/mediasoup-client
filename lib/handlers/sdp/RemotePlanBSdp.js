...
class SendRemoteSdp extends RemoteSdp
{
	...
	createAnswerSdp(localSdpObj)
	{
		...
		// NOTE: We take the third fingerprint because we know that it's sha-256.
		sdpObj.fingerprint =
		{
			type : remoteDtlsParameters.fingerprints[2].algorithm,
			hash : remoteDtlsParameters.fingerprints[2].value
		};
