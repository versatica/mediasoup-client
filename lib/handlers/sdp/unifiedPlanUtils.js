...
/**
 * Fill the given RTP parameters for the given track.
 * NOTE: This also includes legacy multi-ssrc based simulcast for Chrome/Safari.
 *
 * @param {RTCRtpParameters} rtpParameters -  RTP parameters to be filled.
 * @param {Object} sdpObj - Local SDP Object generated by sdp-transform.
 * @param {MediaStreamTrack} track
 */
export function fillRtpParametersWithPlanBSimulcastForTrack(
	rtpParameters, sdpObj, track
)
{
	const kind = track.kind;
	const rtcp =
...
/**
 * Adds multi-ssrc based simulcast (PlanB) into the given SDP for the given track.
 * NOTE: This is for Chrome/Safari using Unified-Plan with legacy simulcast.
 *
 * @param {Object} sdpObj - Local SDP Object generated by sdp-transform.
 * @param {MediaStreamTrack} track
 */
export function addPlanBSimulcastForTrack(sdpObj, track)
{
	const kind = track.kind;
