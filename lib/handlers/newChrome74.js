...
class Chrome74 extends HandlerInterface_1.HandlerInterface {
    ...
    static createFactory() {
        return (options) => new Chrome74(options);
    }
    close() {
        logger.debug('close()');
    ...
    setMaxSpatialLayer(sendId, spatialLayer) {
        return __awaiter(this, void 0, void 0, function* () {
            logger.debug('setMaxSpatialLayer() [sendId:%s, spatialLayer:%s]', sendId, spatialLayer);
            this.assertSendDirection();
            const transceiver = this._mapMidTransceiver.get(sendId);
            if (!transceiver)
                throw new Error('associated RTCRtpTransceiver not found');
    ...
    setRtpEncodingParameters(sendId, params) {
        return __awaiter(this, void 0, void 0, function* () {
            logger.debug('setRtpEncodingParameters() [sendId:%s, params:%o]', sendId, params);
            this.assertSendDirection();
            const transceiver = this._mapMidTransceiver.get(sendId);
            if (!transceiver)
                throw new Error('associated RTCRtpTransceiver not found');
