...
export function extractRtpCapabilities(sdpObject)
{
	...
	for (const m of sdpObject.media)
	{
		...
		for (const rtp of m.rtp)
		{
			...
			const numChannels = rtp.encoding || 1;

			if (numChannels !== 1)
				codec.numChannels = numChannels;
...
/**
 * Extract RTP parameters from a SDP m section (without encodings).
 *
 * @param {Object} mSection - SDP m section Object generated by sdp-transform.
 * @return {RTCRtpParameters}
 */
export function extractRtpParametersWithoutEncodings(mSection)
{
