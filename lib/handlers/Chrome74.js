...
class Chrome74 extends HandlerInterface_1.HandlerInterface {
    ...
    async getNativeRtpCapabilities({ forceAbsCaptureTimeRtpHeaderExtension }) {
    ...
    async send({ track, encodings, codecOptions, codec }) {
        ...
        if (codecOptions === null || codecOptions === void 0 ? void 0 : codecOptions.forceAbsCaptureTimeExten) {
