...
export default class Safari11 extends EventEmitter
{
	static get name()
	{
		return 'Safari11';
		...
		promises.push(
			this._sendPeerConnection.createOffer()
				.then((offer) =>
				{
					...
					const rtpCapabilities = sdpCommonUtils.extractRtpCapabilities(sdpObject);
					const dtlsParameters = sdpCommonUtils.extractDtlsParameters(sdpObject);
