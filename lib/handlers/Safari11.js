...
class Safari11 extends HandlerInterface_1.HandlerInterface {
    ...
    async send({ track, encodings, codecOptions, codec, localDtlsRole }) {
    ...
    async sendDataChannel({ ordered, maxPacketLifeTime, maxRetransmits, label, protocol, priority, localDtlsRole }) {
        this._assertSendDirection();
        const options = {
            negotiated: true,
    ...
    async receive({ trackId, kind, rtpParameters, localDtlsRole }) {
    ...
    async receiveDataChannel({ sctpStreamParameters, label, protocol, localDtlsRole }) {
        this._assertRecvDirection();
