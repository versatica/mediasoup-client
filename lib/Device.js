...
export default class Device
{
	...
	static _detect()
	{
		...
		if (global.navigator && typeof global.navigator.userAgent === 'string')
		{
			...
			if (bowser.check({ chrome: '55', chromium: '55' }, true, ua))
			{
				Device._flag = 'chrome';
		...
		else if (global.navigator && global.navigator.product === 'ReactNative')
		{
			Device._flag = 'react-native';
			Device._name = 'ReactNative';
			Device._version = 'unknown';
			Device._bowser = {};
			Device._handlerClass = Chrome55; // TODO: Let's see.
		}
		// Otherwise fail.
		else
		{
