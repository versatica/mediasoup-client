...
class Device {
    ...
    _detectDevice() {
        ...
        if (typeof navigator === 'object' && navigator.product === 'ReactNative') {
            ...
            return ReactNative_1.ReactNative.createFactory();
        }
        // Browser.
