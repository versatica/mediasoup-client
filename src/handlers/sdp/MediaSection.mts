...
import type { ProducerCodecOptions } from '../../Producer.mts';
import type {
	MediaKind,
	RtpParameters,
	RtpCodecParameters,
...
import type { SctpParameters } from '../../SctpParameters.mts';
		...
		switch (offerMediaObject.type) {
			...
			case 'video': {
				...
				for (const codec of answerRtpParameters!.codecs) {
					...
					let codecRtcpFeedback: RtcpFeedback[] =
						utils.clone(codec.rtcpFeedback) ?? [];
