...
import { UnsupportedError } from '../errors.mts';
import * as utils from '../utils.mts';
import * as ortc from '../ortc.mts';
import * as sdpCommonUtils from './sdp/commonUtils.mts';
import * as sdpPlanBUtils from './sdp/planBUtils.mts';
import {
	type HandlerFactory,
	HandlerInterface,
...
export class Chrome55 extends HandlerInterface {
	...
	private readonly _mapSendLocalIdTrack: Map<string, MediaStreamTrack> =
		new Map();
